...
INPUT_IDS = [
    ...
    'input-a_coef', 'input-b_coef', 'input-theta', 'input-S_param', 'input-min_debit_well', 'input-min_p_wellhead', 'input-dP_max', 'input-K_eks',
    'input-DKS_mode', 'input-P_vh_DKS', 'input-P_vyh_DKS', 'input-N_DKS', 'input-Q_max_DKS',
...
INPUT_PARAM_MAPPING = {
    ...
    'input-b_coef': 'b_coef',
    'input-theta': 'theta',
    'input-S_param': 'S_param',
    'input-min_debit_well': 'min_debit_well',
    'input-min_p_wellhead': 'min_p_wellhead',
    'input-dP_max': 'dP_max',
    'input-K_eks': 'K_eks',
...
def run_calculation(n_clicks, params):
    ...
    calc_params = {
        ...
        'S_param': params.get('S_param', 0),
        'min_debit_well': params.get('min_debit_well', 0),
        'min_p_wellhead': params.get('min_p_wellhead', 0),
        ...
        'Q_max_DKS': params.get('Q_max_DKS', 0),
